...
<div class="breadcrumbs">
	<a href="/admin/">Home</a>&rsaquo; <a href="/admin/${entity}/">${entity}</a>
	&rsaquo; Add ${entity}
</div>
<!-- Content -->
<%
...
<div id="content" class="colM">
	...
	<h1>Add ${entity}</h1>
	<div id="content-main">
		<form enctype="multipart/form-data" action="/admin/${entity}/add"
 ...
 %>:
						...
						<div class="related-widget-wrapper">
							<select name="<%out.print(field);%>" required
								...
								%>
								<option value="<%out.print(((Category) obj).getId());%>">
									<%
								...
								%>
								<option value="<%out.print(((SubCategory) obj).getId());%>">
									<%
								...
								%>
								<option value="<%out.print(((Item) obj).getId());%>">
									<%
								...
								%>
								<option value="<%out.print(((Order) obj).getId());%>">
									<%
								...
								%>
								<option value="<%out.print(((OrderItem) obj).getId());%>">
									<%
								...
								%>
								<option value="<%out.print(((User) obj).getId());%>">
									<%
